...
* [`src/clj/reframe_2020+/`](src/clj/reframe_2020+/): CSS compilation source files (Clojure,
[Garden](https://github.com/noprompt/garden))
* [`src/cljs/reframe_2020+/`](src/cljs/reframe_2020+/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/cljs/reframe_2020+/core.cljs): contains the SPA entry point, `init`
...
7. Clone this repo and open a terminal in the `reframe-2020+` project root directory
...
in the [`src/clj/reframe_2020+/`](src/clj/reframe_2020+/) directory. CSS files are compiled
...
The `debug?` variable in [`config.cljs`](src/cljs/reframe_2020+/config.cljs) defaults to `true` in
[`dev`](#running-the-app) builds, and `false` in [`prod`](#production) builds.

Use `debug?` for logging or other tasks that should run only on `dev` builds:

```clj
(ns reframe-2020+.example
  (:require [reframe-2020+.config :as config])
